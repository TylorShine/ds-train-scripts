...
SET TRAINING_CONFIG=../configs/acoustic.yaml

SET SAVE_DIR=../trained_models/diffsinger

python ..\..\train.py --save_interval 1000 --batch_size 8 --max_updates 160000 --training_config "%TRAINING_CONFIG%" --save_dir "%SAVE_DIR%" --resume_training --re_config_path "%SAVE_DIR%/config.yaml"
