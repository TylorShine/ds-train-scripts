...
CD content
python ..\extract_data.py --data_type %DATA_TYPE% --data_zip_path "%1" --no_cleanup --estimate_midi SOME --transcription_model "%WHISPER_MODEL%" --transcription_language %WHISPER_LANGUAGE% --g2p_alignment_type %ALIGNMENT_TYPE% %ADDITIONAL_ARGS%
